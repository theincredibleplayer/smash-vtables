...
pub const LOWERCASE_FIGHTER_NAMES: StaticArrayAccessor<&'static str> = StaticArrayAccessor::new(0x4f80e20, 118);

pub const LOWERCASE_WEAPON_NAMES: StaticArrayAccessor<&'static str> = StaticArrayAccessor::new(0x5185bd0, 0x267);

pub const LOWERCASE_WEAPON_OWNER_NAMES: StaticArrayAccessor<&'static str> = StaticArrayAccessor::new(0x5188240, 0x267);